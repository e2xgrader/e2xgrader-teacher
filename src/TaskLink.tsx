...
export default function TaskLink({initiallyLinkedTask, onChange, gradingCells}: {initiallyLinkedTask: string|undefined, onChange: (val: string|undefined) => any, gradingCells: GradingCellModel[]}): React.JSX.Element{
